...
// register database pre-process hook
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_db.php']['queryProcessors'][] = 'JWeiland\\Events2\\Hooks\\DatabasePreProcess';
