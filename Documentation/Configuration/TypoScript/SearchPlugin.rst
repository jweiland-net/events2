...
In Extbase a link will be created by its Plugin Namespace like *tx_events2_search* or *tx_events2_list*. As we have
...
compatible with our Event Plugin we have to change its Plugin Namespace to *tx_events2_list*.
