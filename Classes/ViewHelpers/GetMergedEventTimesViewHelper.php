...
class GetMergedEventTimesViewHelper extends AbstractViewHelper {
	 ...
	 * @param boolean $directReturn If event has only ONE time record defined, you can set this value to TRUE to direct return this time record instead of a SplObjectStorage
