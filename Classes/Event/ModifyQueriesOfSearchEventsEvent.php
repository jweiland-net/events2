...
{
    public function __construct(protected readonly QueryBuilder $queryBuilder, protected readonly QueryBuilder $subQueryBuilder, protected Search $search, protected array $settings)
    {
    }
