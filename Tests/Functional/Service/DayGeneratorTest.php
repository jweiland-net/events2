...
class DayGeneratorTest extends FunctionalTestCase
{
    ...
    public function initializeWithRecurringEventCallsAddRecurringEvents(): void
    {
        ...
        $eventBegin->setTimezone(new \DateTimeZone(date_default_timezone_get()));
    ...
    public function initializeWithRecurringWeeksResetsDayToMidnight(): void
    {
        ...
        $recurringEnd->setTimezone(new \DateTimeZone(date_default_timezone_get()));

        $event = [
            'uid' => 123,
            'event_type' => 'recurring',
            'event_begin' => $eventBegin,
            'event_end' => $recurringEnd,
            'xth' => 31,
            'weekday' => 127,
            'each_weeks' => 1,
            'each_months' => 0
