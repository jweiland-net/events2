...
class EventControllerTest extends UnitTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->controllerContext = $this->getMock('TYPO3\\CMS\\Extbase\\Mvc\\Controller\\ControllerContext', array('dummy'));
        ...
        $this->locationRepository = $this->getMock(LocationRepository::class, array(), array(), '', false);
        $this->categoryRepository = $this->getMock(CategoryRepository::class, array(), array(), '', false);
        $this->objectManager = $this->getMock(ObjectManager::class, array(), array(), '', false);
    ...
    public function newActionWithImagesCallsDeleteUploadedFiles()
    {
        ...
        $originalResource = $this->getMock(FileReference::class, array(), array(), '', false);
        $originalResource
            ->expects($this->once())
            ->method('delete');
